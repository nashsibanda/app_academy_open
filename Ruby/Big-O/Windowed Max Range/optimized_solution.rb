...
n = 10000
Benchmark.bm do |x|
  x.report { n.times do ; windowed_max_range([1, 3, 2, 5, 4, 8, 5, 3, 67, 8, 4, 4, 6, 78, 4], 5); end }
end
Benchmark.bm do |x|
  x.report { n.times do ; naive_windowed_max_range([1, 3, 2, 5, 4, 8, 5, 3, 67, 8, 4, 4, 6, 78, 4], 5) ; end }
end
